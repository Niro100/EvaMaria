...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('NFLK Updates ✅', url='http://t.me/NFLK_Updates')
            ],[
            InlineKeyboardButton('🔍 Search කරන්න', switch_inline_query_current_chat=''),
            InlineKeyboardButton('🔰Support Group🔰', url='https://t.me/EvaMariaUpdates')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('Bots & Channels', callback_data='manuelfilter'),
            ...
            InlineKeyboardButton('How To Use 🤔', callback_data='stats')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons= [[
            ...
            InlineKeyboardButton('Support ⚡', callback_data='source')
            ],[
            InlineKeyboardButton('🏠 Home', callback_data='start'),
